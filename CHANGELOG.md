...
## [1.1.1](https://github.com/vaultrice/sdk/compare/v1.1.0...v1.1.1) - 2025-11-18

- Improved retry logic for transient server errors: HTTP 5xx responses (including "500 - Internal Server Error") and common transient error messages are now treated as retryable.
